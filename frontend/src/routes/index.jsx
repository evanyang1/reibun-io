    ...
    <div className="pt-20">
      ...
      <section className="mt-10 flex items-center justify-center gap-2">
        <input
          type="text"
          placeholder="i.e. 機会"
          className="w-72 rounded-md border border-gray-300 p-2.5 shadow-sm focus:border-blue-500
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-md bg-teal-500 px-4 py-2.5 text-sm font-semibold
           ...
           focus-visible:outline-offset-2 focus-visible:outline-blue-600 duration-300"
        >
          <CiSearch size={20} />
          <span>Search</span>
        </button>
